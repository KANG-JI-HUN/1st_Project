...
public class IListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ItemlistDao boardDao = new ItemlistDao();
		ArrayList<ItemlistDto> list = boardDao.list(startRow, endRow);
		request.setAttribute("list", list);
		int totCnt = boardDao.getItemlistTotCnt(); // 글갯수
