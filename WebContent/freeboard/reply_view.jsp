...
<div id="content">
	...
	enctype="multipart/form-data">
		...
		<table>
			<caption>${reply_view.fNo }번글의 답변쓰기 폼</caption>
			<tr><td>작성자</td><td>${member.cName }(${member.cId })님</td></tr>
			<tr><td>제목</td><td><input type="text" name="fSubject"
							required="required" size="30"
							value="[답]${reply_view.fSubject }"></td></tr>
